...
(function( window, document, $ ) {
	...
	function addWavableFlag() {
		...
		flag_vertical.style.backgroundImage = 'url(https://res.cloudinary.com/rezdelamasa/image/upload/v1565794594/ApexLegend/category-flag-left.png)';
		...
		try {
			...
			Wave.addWavableImage({ image_src : 'https://res.cloudinary.com/rezdelamasa/image/upload/v1565794594/ApexLegend/category-flag-left.png', canvas_id: 'flag-vertical-canvas' });
		} catch( e ) {
